...
SOCSTREAM_OPTS="${SOCSTREAM_OPTS} --data ${SOCSTREAM_HOME}/data/test/dataset-test.txt"
SOCSTREAM_OPTS="${SOCSTREAM_OPTS} --metadata ${SOCSTREAM_HOME}/data/test/dataset-test.txt"
SOCSTREAM_OPTS="${SOCSTREAM_OPTS} --parallelism 1"
